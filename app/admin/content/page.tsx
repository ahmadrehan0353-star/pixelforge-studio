...
const defaults: SiteContent = {
  ...
  process: [
    { title: "Tell us about your business", description: "" },
    { title: "We design a FREE homepage preview", description: "" },
    { title: "You approve the design", description: "" },
    { title: "We build the complete website", description: "" },
    { title: "Launch and support", description: "" },
  ],
  ctaFreeMockup: {
