...
import { processSteps as staticSteps } from "@/lib/data";
import Reveal from "@/components/Reveal";
import { usePublicDocument } from "@/lib/usePublicFirestore";

const defaultProcess = staticSteps.map((s) => ({ title: s.title, description: s.description }));

export default function Process() {
  const { data } = usePublicDocument("settings/content", { process: defaultProcess });
