...
const fallback: Testimonial[] = staticTestimonials.map((t, i) => ({
  name: t.name,
  company: t.role,
  review: t.quote,
  rating: 5,
...
export default function TestimonialsSlider() {
  const { items } = usePublicCollection<Testimonial>("testimonials", fallback, "published");
        ...
        <div className="glass-panel min-h-[220px] overflow-hidden px-8 py-10 sm:px-14">
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <p className="text-sm text-mist-500">{t.company}</p>
            </motion.div>
          </AnimatePresence>
        </div>
